...
<div align="center">
   ...
   <% for (int i = 0; i < taille; i++) {%>
     <tr bgcolor="<%=(i%2==0)?"#FFEBBF":"#FFFFFF"%>">
      ...
      <th width="205" scope="col"><div align="left"><%=((CommandeBean)al.get(i)).getIdCommande()%></div></th>
      <th width="120" scope="col"><div align="left"><%=Utilitaire.getDateEuropeenne(((CommandeBean)al.get(i)).getDateCommande())%></div></th>
	  <th width="305" scope="col"><div align="left"><%=((CommandeBean)al.get(i)).getNomClient()%></div></th>
	  <th width="180" scope="col"><div align="left"><%=((CommandeBean)al.get(i)).getMontant()%></div></th>
    </tr>
	<%}%>
  </table>
</div>
